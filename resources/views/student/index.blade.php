            ...
            <div class="card card-default">
                <div class="card-header">
                    ...
                    <div class="col-md-6 card-head-div">
                        ...
                        <label class='file-label btn btn-primary mb-0 mr-2'><i class="fa-solid fa-file-excel mr-2"></i>Choose Excel File
                        <input type="file" class="" name="file" accept="" id="import" title="Choose excel file to insert data" onchange="form.submit()">
                        </label>
                        {{ Form::close() }}
