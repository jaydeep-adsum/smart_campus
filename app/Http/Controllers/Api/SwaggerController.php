 ...
 * @link    http://localhost/smart_campus/api/
 */
 ...
 * @OA\Info(
 *     version="3.1",
 *     title="smart_campus Project REST Service",@OA\Contact(name="smart_campus", url="http://localhost/smart_campus/")
 * )
 * @OA\Server(
 *     description="Local Server",
 *     url="http://localhost/smart_campus/api/"
 * ),
 * @OA\Server(
