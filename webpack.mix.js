...
mix.js('resources/assets/js/student/student.js',
    ...
    .js('resources/assets/js/institute/institute.js',
        'public/assets/js/institute/institute.js')
    .js('resources/assets/js/question/question.js',
    ...
    .js('resources/assets/js/cafeteria_user/cafeteria_user.js',
        'public/assets/js/cafeteria_user/cafeteria_user.js')
